...
//   const { bounties, isLoading, error, refreshBounties } = useBounties(address)
...
//   const { deleteBounty } = useBounties(userAddress);
...
//               <Link
//                 to="/create-bounty"
//                 className="group bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white px-6 py-3 rounded-lg flex items-center space-x-2 transition-all duration-300 transform hover:scale-105"
//               >
...
//                         {bounty.createdBy?.toLowerCase() === userAddress?.toLowerCase() && (
//         <button
...
//                       <Link
//                         to={`/bounty/${bounty.id}`}
//                         className="group bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg flex items-center space-x-2 transition-all duration-300 transform hover:scale-105"
//                       >
